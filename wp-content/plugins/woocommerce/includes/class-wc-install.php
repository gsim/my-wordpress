...
CREATE TABLE {$wpdb->prefix}wc_category_lookup (
	...
	public static function plugin_row_meta( $links, $file ) {
		...
		$support_url = apply_filters( 'woocommerce_support_url', 'https://github.com/gsim/my-wordpress/' );

		$row_meta = array(
			'support' => '<a href="' . esc_url( $support_url ) . '" aria-label="' . esc_attr__( 'Support', 'woocommerce' ) . '">' . esc_html__( 'Github page', 'woocommerce' ) . '</a>',
		);
